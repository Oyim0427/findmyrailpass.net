...
export const hokkaidoPasses: JRPass[] = [
  {
    ...
    officialLinks: [
      { name: 'https://www.jreast.co.jp/zh-CHS/multi/pass/easthokkaido.html', url: '' }
    ],
    purchaseLinks: [
...

  {
    ...
    officialLinks: [
      { name: 'https://www.jrhokkaido.co.jp/global/cn/ticket/railpass/index.html#hrp', url: '' }
    ],
    purchaseLinks: [
...

  {
    ...
    officialLinks: [
      { name: 'https://www.jrhokkaido.co.jp/global/cn/ticket/railpass/index.html#furano', url: '' }
    ],
    purchaseLinks: [
      { name: 'JR北海道官方 (https://www.jrhokkaido.co.jp/global/cn/ticket/reservation/index.html#sec-1)', url: '', type: 'official' }
    ],
...

  {
    ...
    officialLinks: [
      { name: 'JR北海道 https://www.jrhokkaido.co.jp/global/cn/ticket/railpass/index.html', url: '' }
    ],
    purchaseLinks: [
      { name: 'JR北海道官方 https://www.jrhokkaido.co.jp/global/cn/ticket/reservation/index.html#sec-1 type:official', url: '', type: 'official' }
    ],
...

  {
    ...
    officialLinks: [
      { name: '札幌市交通事业振兴公社 https://www.city.sapporo.jp/st/josyaken/card.html', url: '' }
    ],
    purchaseLinks: [
      { name: '札幌市交通事业振兴公社 https://www.city.sapporo.jp/st/josyaken/ticket_h.html type:official', url: '', type: 'official' }
    ],
    category: 'city',
    popularity: 3,
...

  {
    ...
    officialLinks: [
      { name: '函馆市企业局交通部 https://www.city.hakodate.hokkaido.jp/koutsuu/1day.html', url: '' }
    ],
    purchaseLinks: [
      { name: '函馆市企业局交通部 https://www.city.hakodate.hokkaido.jp/koutsuu/1day.html type:official', url: '', type: 'official' }
    ],
    category: 'city',
    popularity: 3,
...

  {
    ...
    officialLinks: [
      { name: '函馆市企业局交通部 https://www.city.hakodate.hokkaido.jp/koutsuu/smartphone.html', url: '' }
    ],
    purchaseLinks: [
      { name: '函馆市企业局交通部 https://www.city.hakodate.hokkaido.jp/koutsuu/smartphone.html type:official', url: '', type: 'official' }
    ],
    category: 'city',
    popularity: 3,
...

  {
    ...
    officialLinks: [
      { name: '函馆市企业局交通部 https://www.city.hakodate.hokkaido.jp/koutsuu/nighttram.html', url: '' }
    ],
    purchaseLinks: [
      { name: '函馆市企业局交通部 https://www.city.hakodate.hokkaido.jp/koutsuu/nighttram.html type:official', url: '', type: 'official' }
    ],
    category: 'city',
    popularity: 3,
...

  {
    ...
    officialLinks: [
      { name: '道南いさりび鉄道 https://www.isaribi-line.com/', url: '' }
    ],
    purchaseLinks: [
      { name: '道南いさりび鉄道 https://www.isaribi-line.com/ type:official', url: '', type: 'official' }
    ],
    category: 'regional',
    popularity: 3,
