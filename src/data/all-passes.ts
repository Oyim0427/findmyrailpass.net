...
export const popularPasses = unifiedPasses
  .sort((a, b) => {
    ...
    // 如果都不是全国版，则按地区列表顺序排列
    const regionOrder = ['北海道','東　北', '関　東', '東　海', '北信越', '近　畿','中　国', '四　国', '九　州'];
    ...
    const getMainRegion = (pass: JRPass) => {
      ...
      const regionKeywords = {
        ...
        '東　北': ['东北', '東北', '青森', '仙台', '秋田', '山形', '福岛'],
        '関　東': ['关东', '関東', '东京', '東京', '富士山', '日光', '轻井泽', '軽井沢', '伊豆'],
        '東　海': ['东海', '東海', '名古屋', '静冈', '静岡', '伊势', '伊勢', '熊野', '和歌山'],
        '北信越': ['北信越', '金泽', '金沢', '飞驒高山', '飛騨高山', '白川鄉', '白川郷', '合掌村'],
        '近　畿': ['近畿', '关西', '関西', '大阪', '京都', '奈良', '神户', '神戸', '仓敷', '倉敷', '冈山', '岡山', '丹後地区'],
        '中　国': ['中国', '广岛', '広島', '山口', '山阳', '山陽', '山阴', '山陰'],
        '四　国': ['四国'],
        '九　州': ['九州', '福冈', '福岡', '博多', '熊本', '鹿儿岛', '鹿児島', '长崎', '長崎', '宫崎', '宮崎']
      };
...
export const regions = [
  '全　国','北海道','東　北', '関　東', '東　海', '北信越', '近　畿','中　国', '四　国', '九　州' 
];
