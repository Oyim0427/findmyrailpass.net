...
export const shikokuPasses: JRPass[] = [
  {
    ...
    purchaseLinks: [
      ...
      { name: 'Klook购买', url: 'https://www.klook.com/zh-CN/activity/58-hiroshima-tourist-pass/', type: 'official' },
      { name: 'KKday购买', url: 'https://www.kkday.com/zh-tw/product/58-hiroshima-tourist-pass', type: 'official' },
      { name: 'Voyagin购买', url: 'https://www.voyagin.com/zh-cn/activities/hiroshima-tourist-pass', type: 'official' }
    ],
    category: 'regional',
    popularity: 3,
...

  {
    ...
    purchaseLinks: [
      ...
      { name: 'Klook购买', url: 'https://www.klook.com/zh-CN/activity/60-sanyo-sanin-pass/', type: 'official' },
      { name: 'KKday购买', url: 'https://www.kkday.com/zh-tw/product/60-sanyo-sanin-pass', type: 'official' },
      { name: 'Voyagin购买', url: 'https://www.voyagin.com/zh-cn/activities/sanyo-sanin-pass', type: 'official' }
    ],
    category: 'regional',
    popularity: 3,
...

  {
    ...
    purchaseLinks: [
      { name: 'JR西日本官方', url: 'https://www.westjr.co.jp/', type: 'official' },
      { name: 'Klook购买', url: 'https://www.klook.com/zh-CN/activity/62-hiroshima-yamaguchi-pass/', type: 'official' },
      { name: 'KKday购买', url: 'https://www.kkday.com/zh-tw/product/62-hiroshima-yamaguchi-pass', type: 'official' },
      { name: 'Voyagin购买', url: 'https://www.voyagin.com/zh-cn/activities/hiroshima-yamaguchi-pass', type: 'official' }
    ],
    category: 'regional',
    popularity: 3,
